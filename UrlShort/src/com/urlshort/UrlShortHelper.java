 ...
 * @author SoftwareSpot
 */
public final class UrlShortHelper {
	...
	static final String chars = "FKM7TJP528YIGOE4Q6SW0D9NAZLVX13CRUBH"; // ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789;

	static final int base = chars.length(); // Base type. Should be 36.

	static final byte shortLength = 5;
