...
final class UrlShortStrings {
    ...
    public static final String EXPAND_INVALID_FORMAT = "Error: Short id is an invalid format";
    public static final String EXPAND_NOT_FOUND = "Error: Not found in the database";
    public static final String EXPAND_NULL_OR_EMPTY = "Error: Short id is null or empty";
    ...
    public static final String SUCCESS_ONLY = "Success: ";
    public static final String UPDATE_INVALID_FORMAT = "Error: Url is an invalid format";
    public static final String UPDATE_NOT_INSERTED = "Error: Not inserted into the database";
    public static final String UPDATE_NULL_OR_EMPY = "Error: Url is null or empty";
}
